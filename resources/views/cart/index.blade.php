        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tbody class="product_list">
                        ...
                        <tr data-id="{{ $item->productSku->id }}">
                            <td>
                                <input type="checkbox" name="select" value="{{ $item->productSku->id }}" {{ $item->productSku->product->on_sale
                                ? 'checked' : 'disabled' }}>
                            </td>
                ...
                <a target="_blank" href="{{ route('products.show', [$item->productSku->product_id]) }}">{{ $item->productSku->product->title }}</a>
                                    ...
                                    <span class="sku_title">{{ $item->productSku->title }}</span> @if(!$item->productSku->product->on_sale)
                                    <span class="warning">该商品已下架</span> @endif
                                </div>
                            </td>
        ...
        $(document).ready(function () {
            ...
            $('.btn-remove').click(function (){
                ...
                .then(function (willDelete){
                    // 用户点击确定按钮,willDelete的值就会是true,否者未false
                    if(!willDelete){
                        return ;    
                    }
            ...
            $("#select-all").change(function(){
                ...
                //获取所有name=select并且不带有disabled的属性勾选框
            ...
            $('.btn-create-order').click(function (){
                ...
                var req={
                    ...
                    items:[],
                    remark:$('#order-form').find('textatea[name=remark]').val(),
                    coupon_code:$('input[name=coupon_code]').val(),//从优惠框输入框中获取优惠码
                };
