...
<div class="row">
    <div class="col-10 offset-1">
        ...
        <div class="card">
            <div class="card-head"><h5 class="mb-0 text-center">分期付款详情</h5></div>
            <div class="card-body">
                <div class="installment-top">
                    <div class="installment-info">
                        <div class="line">
                            ...
                            <div class="line-value">
                                <a href="{{route('orders.show',['order'=>$installment->order_id]) }}"  target="_blank">查看</a>
                            </div>
                        </div>
                        <div class="line">
                    ...
                    <div class="installment-next text-right">
                        <!--如果没有未还款的还款计划,说明已经结清-->
                        @if (is_null($nextItem))
                        <div class="insallment-clear text-center">此订单已经结清</div>
                        @else
                            <div>
                                <span>近期待还:</span>
                                <div class="total-amount value">${{$nextItem->total}}</div>
                            </div>
                            <div>
                                <span>截至日期:</span>
                            ...
                            <a href="{{ route('installments.alipay',['installment'=>$installment->id])}}" class="btn btn-primary btn-sm">支付宝支付</a>
